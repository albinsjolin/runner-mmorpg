...
class_name RunnerPlayerIdentityUniqueIndex extends _ModuleTableUniqueIndex

var _cache: Dictionary[PackedByteArray, RunnerPlayer] = {}
...
func find(col_val: PackedByteArray) -> RunnerPlayer:
