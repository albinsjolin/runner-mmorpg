...
@tool
class_name RunnerCleanupTimer extends _ModuleTableType
...
static func create(p_scheduled_id: int, p_scheduled_at: ScheduleAt) -> RunnerCleanupTimer:
	var result: RunnerCleanupTimer = RunnerCleanupTimer.new()
